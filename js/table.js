        ...
        <tr class="border-b bg-[#373737] text-white  border-[#d9dadb] fira-sans-medium  transition" >
            ...
            <td class="py-4 px-2 text-end max-sm:p-1">
                <a class="md:!w-max inline-block text-end" href="/ticket.htm?id=${item.id}">
                    <button class="flex items-center justify-center bg-[#a81a1a] px-4 py-2 opacity-65  h-[36px] hover:bg-[#d52b1e]    text-sm   duration-200 rounded-[20px]   transition md:!w-[160px] !w-[100px] max-sm:!w-[60px] max-sm:!p-0 max-sm:!text-[12px] max-sm:leading-3">Bilet Al</button>
                </a>
            </td>
        </tr>
        `;
